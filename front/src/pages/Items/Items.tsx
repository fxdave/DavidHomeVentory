      ...
      <List>
        {list.map(item => (
          <Item
            ...
            onDelete={() => {
              authedApi()
                .warehouse.delete.delete({query: {id: item.id}})
                .then(() => {
                  listInvalidate.invalidate();
                })
                .catch(e => {
            ...
            onEdit={newEntry => {
              authedApi()
                .warehouse.update.put({body: newEntry})
                .then(() => {
                  listInvalidate.invalidate();
                })
                .catch(e => {
